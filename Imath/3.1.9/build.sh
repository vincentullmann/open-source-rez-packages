...
export PACKAGE_VERSION=3.1.9.3
...
export PACKAGE_VARIANT=python-3.11/boost-1.85/numpy-1.26
rez-env cmake-3 devtoolset-11 python-3.11 boost-1.85 numpy-1.26 -c ./_rezbuild_.sh
